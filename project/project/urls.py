...
from tickets.views import find_movie
from tickets.views import viewsets_guest, viewsets_movie, viewsets_reservation
...
urlpatterns = [
    ...
    #3.1 GET POST from rest framework func based view @api_view
